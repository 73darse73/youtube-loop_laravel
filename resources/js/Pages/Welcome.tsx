    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-white text-gray-900">
                ...
                {/* ヒーロー */}
                <section className="mx-auto max-w-5xl px-6 pb-0 pt-24 text-center">
                    ...
                    <p className="mx-auto mb-10 max-w-xl text-lg text-gray-500">
                        YouTube動画の指定区間をループ再生・保存できるサービス。
                        語学・楽器・ダンスの練習に。
                    </p>
                    <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
                        <a
                            href="/auth/redirect"
                            className="inline-flex items-center gap-3 rounded-xl bg-gray-900 px-8 py-4 text-base font-semibold text-white shadow-lg transition-colors hover:bg-gray-700"
                        >
                ...
                <section className="py-24">
                    <div className="mx-auto max-w-5xl px-6">
                        ...
                        <div className="grid grid-cols-1 gap-px overflow-hidden rounded-2xl bg-gray-200 sm:grid-cols-2 lg:grid-cols-3">
                            {[
                                {
                                    title: '楽器の練習',
                                    desc: '弾けないフレーズを何度もループ。再生区間だけ絞り込んで集中練習できます。',
                                },
                                {
                                    title: '語学・リスニング',
                                    desc: '聞き取れないセリフをピンポイントでループ。シャドーイングにも最適。',
                                },
                                {
                                    title: 'ダンスの振付確認',
                                ...
                                {
                                    title: '好きなシーンを堪能',
                                    desc: 'お気に入りのシーンを保存して、いつでもすぐ呼び出せます。',
                                },
                                {
                                    title: '講義・解説動画の復習',
                    ...
                    <div className="mx-auto max-w-5xl px-6">
                        ...
                        <div className="space-y-24">
                            <div className="flex flex-col items-center gap-12 sm:flex-row">
                                ...
                                <div className="flex h-52 w-full flex-1 items-center justify-center overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
                                    <img
                                        src="/images/screenshot-home.png"
                                        alt="ループ再生"
                            ...
                            <div className="flex flex-col items-center gap-12 sm:flex-row-reverse">
                                <div className="flex-1">
                ...
                <section className="py-24">
                    <div className="mx-auto max-w-3xl px-6">
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div className="relative rounded-2xl border-2 border-gray-900 bg-white p-8">
                                <div className="absolute -top-3 left-6 rounded-full bg-gray-900 px-3 py-1 text-xs font-bold text-white">
                                    近日公開
                                </div>
                                <div className="mb-1 text-xs font-bold uppercase tracking-widest text-gray-900">
                                    Pro
                                </div>
                                <div className="mb-1 text-4xl font-bold">
                                    未定
